...
#define HD44780_CONFIG_INIT_CNT 1 // Сколько раз посылать команду инициализации.
...
#define HD44780_CONFIG_INITLSTART 0 // Нужна только при работе в 4bit ном режиме. И отвечает за правильную инициализацию.
...
#define HD44780_CONFIG_PAUSE_CMD_E 1 //10 Пауза между поднятием и опусканием E флага (нужно чтобы HD44780 замечал команды)
...
#define HD44780_CONFIG_PAUSE_CMD_START 0 //1000 Пауза после открытия портов. Для некоторых LCD это необходимо. 1ms

#define HD44780_CONFIG_PAUSE_START 0 //40000 Пауза перед инициализацией. По документации надо 40ms

#define HD44780_CONFIG_PAUSE_WRITE_INIT 0 //10 Пауза между поднятием и опусканием E флага при инициализации.

#define HD44780_CONFIG_PAUSE_INIT_STEPONE 0 //4100 Пауза между первой и второй командами инициализации (в документации
        // сказано минимум 4.1ms)

#define HD44780_CONFIG_PAUSE_INIT_STEPTWO 0 //100 Пауза между второй и третьей командами инициализации (в документации
        // сказано минимум 100us)

#define HD44780_CONFIG_PAUSE_INIT_STEPTHREE 0 //100 Пауза между третьей и четверой командами инициализации (в документации
        // сказано минимум 100us)
